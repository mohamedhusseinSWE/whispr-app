...
const PUBLIC_ROUTES = ["/login", "/register", "/", "/about", "/contact", "/pricing"];
const PUBLIC_API_ROUTES = ["/api/trpc", "/api/uploadthing", "/api/webhooks/stripe"];
...
export async function middleware(req: NextRequest) {
  ...
  console.log(`🔒 Middleware: ${req.method} ${url.pathname} - Token: ${token ? 'Present' : 'Missing'}`);
