...
import { MessageSquare, Headphones, Brain, CreditCard, FileAudio, Ghost, Loader2, Plus, Trash, Crown } from 'lucide-react';
            ...
            <>
              ...
              <div className="mb-8">
                <div className="mb-6">
                  ...
                  <p className="text-gray-600">Choose what you'd like to do with your documents</p>
                </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-yellow-700 mt-1">
                        Upgrade to PRO to upload unlimited PDFs and unlock all features.
                      </p>
                    </div>
                    <Button
