...
import { Loader2, Play, Pause, Headphones, RefreshCw, Rewind, FastForward } from "lucide-react";
...
const PodcastPanel: React.FC<PodcastPanelProps> = ({ fileId, initialPodcast }) => {
  ...
  const [currentSection, setCurrentSection] = useState<PodcastSection | null>(null);
  ...
  const handlePlayPause = (section?: PodcastSection) => {
    ...
    if (currentSectionRef.current?.id === targetSection.id && audioRef.current) {
      if (isPlaying) {
        audioRef.current.pause();
        setIsPlaying(false);
      } else {
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <Button onClick={regeneratePodcast} className="flex items-center gap-2">
    ...
    <div className="flex h-full">
      ...
      <div className="flex-1 p-6">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <Badge variant="outline">
              {podcast.sections.length} section{podcast.sections.length !== 1 ? 's' : ''}
            </Badge>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Podcast Sections</h2>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="ml-4">
                    ...
                    >
                      ...
                      {isPlaying && currentSection?.id === section.id ? 'Pause' : 'Play'}
                    </Button>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-center gap-4">
              <Button 
                ...
                disabled={!currentSection?.audioUrl || currentSection.audioUrl === null}
