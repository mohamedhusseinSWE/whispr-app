...
export default function TranscriptPageWithSidebar({ file }: TranscriptPageWithSidebarProps) {
    ...
    const fetchTranscript = async () => {
      try {
        ...
        if (transcriptData.error) {
          console.log('Transcript not found, will need to generate:', transcriptData.error);
          setTranscript("");
          setError("No transcript found. Click 'Generate Transcript' to create one from your PDF content.");
        } else {
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Document content in text format</p>
                </div>
              </div>
            ...
            {loading ? (
              <div className="flex items-center justify-center py-12">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">{loadingMessage || "Loading transcript..."}</p>
                </div>
              </div>
            ) : error ? (
              <div className="text-center py-12">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 max-w-md mx-auto">
                  ...
                  <h3 className="text-lg font-semibold text-yellow-800 mb-2">No Transcript Available</h3>
              ...
              <div className="text-center py-12">
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 max-w-md mx-auto">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">No Transcript</h3>
                  <p className="text-gray-600 mb-4">Generate a transcript from your PDF content to view it in text format.</p>
                  <Button
                    onClick={generateTranscript}
                    disabled={generating}
                    className="bg-blue-600 hover:bg-blue-700"
